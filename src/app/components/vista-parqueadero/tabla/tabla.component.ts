...
import { TicketParqueaderoResponse } from '../../../models/parqueadero/ticketsParqueadero';
...
export class TablaComponent implements OnInit {
  ...
  public tickets: TicketParqueaderoResponse[] = [];
  ...
  private cargarTickets(): void {
    this.ticketService
      ...
      .subscribe({
        next: (page: Page<TicketParqueaderoResponse>) => {
