...
import {
  TicketEntradaParqueaderoRequest,
  TicketMensualidadParqueaderoRequest,
...
export class TicketParqueaderoService {
  ...
  obtenerTodos(
  ...
  ): Observable<Page<TicketParqueaderoResponse>> {
    ...
    return this.http
      .get<Page<TicketParqueaderoResponse>>(this.apiUrl, {
        params,
        observe: 'response',
      })
      .pipe(
        map((response: HttpResponse<Page<TicketParqueaderoResponse>>) => {
          if (response.status === 204) {
            ...
            return {
              ...
              number: page,
              size: size,
            } as Page<TicketParqueaderoResponse>;
          }
          // Si hay contenido, devuelve el cuerpo de la respuesta.
          return response.body as Page<TicketParqueaderoResponse>;
        })
      );
  }
   ...
   */
  obtenerPorId(id: number): Observable<TicketParqueaderoResponse> {
    return this.http.get<TicketParqueaderoResponse>(`${this.apiUrl}/id/${id}`);
  }

  /**
   * Buscar ticket por código. sirve para reimpresion del ticket
   */
  obtenerPorCodigo(codigo: string): Observable<TicketParqueaderoResponse> {
    return this.http.get<TicketParqueaderoResponse>(
   ...
   */
  crearEntrada(
    request: TicketEntradaParqueaderoRequest
  ): Observable<TicketParqueaderoResponse> {
    return this.http.post<TicketParqueaderoResponse>(
      `${this.apiUrl}/entrada`,
      request
    );
  }
   ...
   */
  crearMensualidad(
    request: TicketMensualidadParqueaderoRequest
  ): Observable<TicketParqueaderoResponse> {
    return this.http.post<TicketParqueaderoResponse>(
   ...
   */
  actualizarSalida(
    request: TicketSalidaParqueaderoRequest
  ): Observable<TicketParqueaderoResponse> {
    return this.http.put<TicketParqueaderoResponse>(
      `${this.apiUrl}/salida`,
      request
    );
  }
  ...
  public generarTicketHistorial(cierre: TicketCierreParqueaderoResponse): string {
    const INIT = '\x1B\x40';
